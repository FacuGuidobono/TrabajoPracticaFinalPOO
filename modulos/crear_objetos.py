...
profesores = [ Encargado(random_name(),random_lastname(), random_materia(),random_cursos(),random_div()) for _ in range(15)] # creamos 15 profesores con valores random
...
def crear_base_de_datos():
     ...
     with open('data/alumnos.txt', 'w') as archivo:
          for alumno in alumnos:
               alumno_data = alumno.fecha + ','+ alumno.nombre + ',' + alumno.apellido + ',' + alumno.materia + ',' + str(alumno.curso) + ',' + alumno.division + ',' + str(alumno.nota) + '\n'
